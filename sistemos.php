...
<body>
  ...
  <div class="container">
    <div class="section">
      ...
      <div id="myModal" class="modal">
        ...
        <!-- <div id="caption"></div>-->
        <a class="prev" id="prev_image" onclick="plusSlides(-1)">&#10094;</a>
        <a class="next" id="next_image" onclick="plusSlides(1)">&#10095;</a>
          ...
          <div class="row" >
            <div class="col s12 m6 l4" style="width:100%">
              <div  class="mySlides fade" >
                ...
                <img src="images/sistemos1.jpg" alt="" id="slideshow_image" >
              </div>
            </div>
            <div class="col s12 m6 l4" style="width:100%">
              <div  class="mySlides fade">
  ...
  // Write all the names of images in slideshow
      var images = [ "sistemos1" , "sistemos2" , "sistemos3" , "sistemos4" ];
